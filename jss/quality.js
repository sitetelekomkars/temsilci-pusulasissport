...
async function fetchEvaluationsForAgent(forcedName, silent = false) {
    ...
    try {
        ...
        if (data && data.result === "success") {
            ...
            // Veriler artık veritabanı seviyesinde (api_service) filtrelenmiş olarak geliyor.
            ...
            // HATA VEYA BAŞARISIZLIK DURUMU - Yükleniyor takılı kalmasın!
            if (!silent) {
                listEl.innerHTML = `
                <div style="text-align:center; padding:40px; color:#666;">
                    <i class="fas fa-search" style="font-size:2rem; color:#cbd5e0; margin-bottom:15px;"></i>
                    <p style="font-weight:600;">Kayıt bulunamadı.</p>
                    <p style="font-size:0.85rem; color:#888;">Bu dönem veya filtre için değerlendirme kaydı mevcut değil.</p>
                </div>`;
            }
        }
    } catch (err) {
