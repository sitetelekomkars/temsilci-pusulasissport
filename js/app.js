...
function checkAdmin(role) { 
    ...
    // Bu, önceki oturumdan kalan 'editing' sınıfını temizler.
...
function toggleEditMode() { 
    ...
    // Admin değilse veya admin modu kapalıysa geri dön
